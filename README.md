...
* **The current version is Trailblazer 2.1.** We do have comprehensive [API documentation](https://trailblazer.to/2.1/docs/trailblazer.html) ready for you. If you're new to TRB start with our [LEARN page](https://trailblazer.to/2.1/docs/trailblazer/#trailblazer-learn).
...
![The new beginner's guide.](https://github.com/trailblazer/trailblazer/blob/master/doc/s_hero.png?raw=true)
